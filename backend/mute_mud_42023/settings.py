"""
Django settings for mute_mud_42023 project.
...
ROOT_URLCONF = 'mute_mud_42023.urls'
...
WSGI_APPLICATION = 'mute_mud_42023.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_mud_42023 API",
    "DESCRIPTION": "API documentation for mute_mud_42023 App",
    "VERSION": "v1",
}
